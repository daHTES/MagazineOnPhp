		...
		<div class="container">
			<div class="single-main">
				...
				<div class="sngl-top">
					...
					<?php 
					$cats = \shop\App::$app->getProperty('category');
					...
					<div class="col-md-7 single-top-right">
						...
						<h2><?= $product->title;?></h2>
							...
							<h5 id="base-price" data-base="<?=$product->price * $curr['value']?>" class="item_price"><?=$curr['symbol_left']?><?=$product->price * $curr['value']?><?=$curr['symbol_right'];?><?=$product->price;?></h5>
							<?php if ($product->old_price):?>
										<small><del><?=$curr['symbol_left']?>
										<?=$product->old_price * $curr['value'];?><?=$curr['symbol_right'];?></del></small>
									<?php endif;?>
							<p><?=$product->content;?></p>
							<?php if ($mods):?>
							<div class="available">
				...
				<div class="latestproducts">
					<div class="product-one">
						<h3>С этим гавном тарят еще такое!</h3>
							...
							<div class="product-main simpleCart_shelfItem">
								...
								<div class="product-bottom">
									...
									<span class="item_price">
										<?=$curr['symbol_left']?><?=$item['price'] * $curr['value']?><?=$curr['symbol_right'];?><?=$item['price'];?></span></h4>
								</div>
								<small><del><?=$curr['symbol_left']?>
										<?=$item['old_price'] * $curr['value'];?><?=$curr['symbol_right'];?></del></small>
								<div class="srch">
									<span>-50%</span>
								</div>
							</div>
				...
				<div class="latestproducts">
					<div class="product-one">
						<h3>Вы не давно на этот кал вытрещали бэньки!</h3>
